...
@unittest.skipIf(
    not pathlib.Path("/mnt/scratch_dir/hernanda").exists(),
...
class TestDownloadDbs(unittest.TestCase):
    ...
    def test_download_all_dbs(self):
        ...
        downloads = download_dbs.DownloadsJunoTyping(
            path_to_db,
            update_dbs=True,
...
class TestJunoTypingDryRun(unittest.TestCase):
    ...
    def test_junotyping_dryrun(self):
        ...
        juno_typing_run = juno_typing.JunoTypingRun(
    ...
    def test_junotyping_dryrun_wMetadata(self):
        ...
        self.assertTrue(
            juno_typing_run.successful_run,
            "Exception raised when running a dryrun and providing a metadata file",
        )
...
class TestJunoTypingPipeline(unittest.TestCase):
    ...
    def test_junotyping_run_wMetadata(self):
        ...
        pipeline_run = juno_typing.JunoTypingRun(
            input_dir="/data/BioGrid/hernanda/test_data_per_pipeline/Enteric/Juno-typing/",
            db_dir="/mnt/db/juno/typing_db",
