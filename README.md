...
Importantly, the Juno-Typing pipeline works directly on output generated from the [Juno-assembly pipeline](https://github.com/RIVM-bioinformatics/juno-assembly).
...
3. If appropriate for the genus/species, the samples will be serotyped. The currently supported species are:
    - _Salmonella_ serotyper by using the [SeqSero2](https://journals.asm.org/doi/10.1128/aem.01746-19?permanently=true&) tool. The [SISTR](https://doi.org/10.1371/journal.pone.0147101) tool is also used to provide extra information for certain edge cases.
