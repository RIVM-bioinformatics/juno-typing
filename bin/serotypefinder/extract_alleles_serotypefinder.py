...
def main(data_json_path, output_csv):
    ...
    if h_type != "No hit found":
        ...
        h_type = pd.DataFrame.from_dict(
            {
                "no_H_hit": {
                    "gene": "No hit found",
                    "serotype": "No hit found",
                    "identity": 0,
                    "HSP_length": 0,
                    "template_length": 0,
                    "position_in_ref": "NA",
                    "contig_name": "NA",
                    "positions_in_contig": "NA",
                    "accession": "NA",
                    "coverage": 0,
                    "hit_id": "NA",
                }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Extract information from serotypefinder results"
    )
    parser.add_argument(
        "file_path",
        type=str,
